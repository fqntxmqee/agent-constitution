...
| 智能体 | 文件路径 | 状态 |
|--------|---------|------|
| 需求澄清 | `agents/constitution/requirement-clarification/AGENTS.md` | ✅ V3.15.0 |
| 需求理解 | `agents/constitution/requirement-understanding/AGENTS.md` | ✅ V3.15.0 |
| 需求解决 | `agents/constitution/requirement-resolution/AGENTS.md` | ✅ V3.15.0 |
| 需求验收 | `agents/constitution/requirement-acceptance/AGENTS.md` | ✅ V3.15.0 |
| 需求交付 | `agents/constitution/requirement-delivery/AGENTS.md` | ✅ V3.15.0 |
| 进展跟进 | `agents/constitution/progress-tracking/AGENTS.md` | ✅ V3.15.0 |
| 审计 | `agents/constitution/audit/AGENTS.md` | ✅ V3.15.0 |
| 总结反思 | `agents/constitution/summary-reflection/AGENTS.md` | ✅ V3.15.0 |
| 调试专家 | `agents/constitution/debugger/AGENTS.md` | ✅ V3.15.0 |
