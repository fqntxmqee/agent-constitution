...
```bash
# 1. 创建归档目录（本地，不提交）
mkdir -p .archive/projects/fitbot-pro
...
# 3. 记录归档日志
echo "2026-03-12: Archived fitbot-pro to .archive/projects/" >> .archive/ARCHIVE_LOG.md
...
# 检查禁止目录
FORBIDDEN_DIRS=("agents/fitbot" "node_modules" "openspec/changes/fitbot")
...
- 宪法规范 V3.7.4: `agents/docs/specs/CONSTITUTION_V3.7.md`
- 审计规范：`agents/docs/specs/AUDIT_SPEC.md`
- Git 规范：`agents/docs/guides/GIT_WORKFLOW.md`
