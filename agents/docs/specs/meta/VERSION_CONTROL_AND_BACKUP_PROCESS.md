...
|------|--------|----------|----------|
| **宪法规范** | `agents/docs/specs/constitution/` | `agents/docs/versions/V{version}/constitution/` | 飞书知识库 |
| **智能体定义** | `agents/constitution/*/AGENTS.md` | `agents/docs/versions/V{version}/agents/` | 飞书知识库 |
| **技能** | `agents/skills/` | `agents/docs/versions/V{version}/skills/` | 飞书知识库 |
| **变更日志** | `agents/docs/specs/constitution/CHANGELOG.md` | `agents/docs/versions/` | 飞书文档 |
...
**位置**: `agents/docs/versions/V{version}/constitution/`（先版本目录，再 constitution）

**查询方式**:
```bash
# 查看所有版本
ls -la agents/docs/versions/V3.7.3/constitution/

# 查看特定版本
cat agents/docs/versions/V3.7.0/constitution/CONSTITUTION_V3.7.0.md

# 查看最新版本
cat agents/docs/versions/latest/constitution/CONSTITUTION_V3.7.2.md
```
...
```bash
# 回滚到 V3.7.0
cp agents/docs/versions/V3.7.0/constitution/CONSTITUTION_V3.7.0.md \
...
|------|------|---------|---------|---------|
| V3.7.0 | 2026-03-09 | 初始版本 | `agents/docs/versions/V3.7.0/constitution/` | 待生成 |
| V3.7.1 | 2026-03-10 | 增加审计智能体职责 | `agents/docs/versions/V3.7.1/constitution/` | 待生成 |
...
|--------|---------|------|---------|---------|
| skill-01 | V1.0.0 | 2026-03-09 | `agents/docs/versions/V3.7.0/skills/` | 待生成 |
| skill-03 | V1.0.0 | 2026-03-09 | `agents/docs/versions/V3.7.0/skills/` | 待生成 |
| ... | ... | ... | ... | ... |
...
VERSION="V3.7.2"
DATE=$(date +%Y-%m-%d)
BACKUP_DIR="agents/docs/versions/${VERSION}/constitution"

# 创建备份目录
mkdir -p ${BACKUP_DIR}

# 复制宪法规范
cp agents/docs/specs/constitution/CONSTITUTION_${VERSION}.md ${BACKUP_DIR}/

# 复制变更日志
cp agents/docs/specs/constitution/CHANGELOG.md ${BACKUP_DIR}/CHANGELOG_${VERSION}.md

# 创建时间戳
echo "备份时间：$(date +%Y-%m-%d_%H:%M:%S)" > ${BACKUP_DIR}/backup_timestamp.txt

# 更新符号链接
ln -sfn ${VERSION} agents/docs/versions/latest
