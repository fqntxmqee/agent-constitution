...
**状态**: 📝 待用户确认  
**流程依据**: `agents/docs/specs/CONSTITUTION_ITERATION_PROCESS.md`
...
- `agents/docs/specs/CONSTITUTION_V3.7.md` 第三章 3.4 节
...
**影响范围**:
- `agents/docs/specs/SKILLS_NAMING_CONVENTION.md`（新增）
- `agents/skills/skills_manifest.json`（新增）
- `agents/docs/specs/CONSTITUTION_V3.7.md` 第六章
...
- `agents/docs/specs/CONSTITUTION_V3.7.md` 第二章 3.5 节
...
**影响范围**:
- `agents/docs/specs/CONSTITUTION_V3.7.md` 第二章 6.3 节
- `HEARTBEAT.md`（引用更新）
...
- `agents/docs/specs/CONSTITUTION_V3.7.md` 第七章
...
| 文件/目录 | 备份类型 | 备份位置 |
|-----------|---------|----------|
| `CONSTITUTION_V3.7.md` | 全量备份 | `versions/constitution/V3.7.3/` |
| `agents/constitution/*/AGENTS.md` | 受影响 4 个 | `versions/agents/V3.7.3/` |
| `agents/skills/*` | 全量备份（推荐） | `versions/skills/V3.7.3/` |
...
| `agents/docs/specs/CONSTITUTION_V3.7.md` | 整合所有变更 | 🔴 P0 |
| `agents/docs/specs/SKILLS_NAMING_CONVENTION.md` | 新增规范 | 🟡 P1 |
| `agents/skills/skills_manifest.json` | 新增注册表 | 🟡 P1 |
| `agents/docs/specs/CHANGELOG.md` | 新增变更日志 | 🟡 P1 |
...
```bash
# 1. 创建版本目录
mkdir -p agents/docs/specs/versions/constitution/V3.7.3/
mkdir -p agents/docs/specs/versions/agents/V3.7.3/
mkdir -p agents/docs/specs/versions/skills/V3.7.3/

# 2. 备份宪法规范主文档
cp agents/docs/specs/CONSTITUTION_V3.7.md agents/docs/specs/versions/constitution/V3.7.3/CONSTITUTION_V3.7.md

# 3. 备份相关智能体 AGENTS.md（受影响的 4 个）
cp agents/constitution/requirement-acceptance/AGENTS.md agents/docs/specs/versions/agents/V3.7.3/
cp agents/constitution/requirement-delivery/AGENTS.md agents/docs/specs/versions/agents/V3.7.3/
cp agents/constitution/requirement-understanding/AGENTS.md agents/docs/specs/versions/agents/V3.7.3/

# 4. 备份技能目录（全部技能）
# 方案 A: 全量备份（推荐，确保完整性）
cp -r agents/skills/* agents/docs/specs/versions/skills/V3.7.3/

# 方案 B: 仅备份受影响的技能（如 Skill-06 需要重命名）
# cp -r agents/skills/skill-06-* agents/docs/specs/versions/skills/V3.7.3/
# cp -r agents/skills/skill-11-* agents/docs/specs/versions/skills/V3.7.3/

# 5. 记录备份时间戳
date +"备份时间：%Y-%m-%d_%H:%M:%S" > agents/docs/specs/versions/constitution/V3.7.3/backup_timestamp.txt
```
...
```bash
# 1. Git add 所有变更文件
git add agents/docs/specs/CONSTITUTION_V3.7.3_PROPOSAL.md
...
git add agents/docs/specs/SKILLS_NAMING_CONVENTION.md
git add agents/skills/skills_manifest.json
git add agents/docs/specs/versions/
...
## 阶段 0: 备份 🔴
- [ ] 创建 versions/constitution/V3.7.3/ 目录
- [ ] 创建 versions/agents/V3.7.3/ 目录
- [ ] 创建 versions/skills/V3.7.3/ 目录
- [ ] 备份 CONSTITUTION_V3.7.md → versions/constitution/V3.7.3/
- [ ] 备份 requirement-acceptance/AGENTS.md → versions/agents/V3.7.3/
- [ ] 备份 requirement-delivery/AGENTS.md → versions/agents/V3.7.3/
- [ ] 备份 requirement-understanding/AGENTS.md → versions/agents/V3.7.3/
- [ ] 备份 skills/* → versions/skills/V3.7.3/（全量或受影响技能）
